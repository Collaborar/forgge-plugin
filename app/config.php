...
return [
	 ...
	 */
	'providers'           => [
		\ForggeAppCore\AppCore\AppCoreServiceProvider::class,
		\ForggeAppCore\Assets\AssetsServiceProvider::class,
		\ForggeAppCore\Avatar\AvatarServiceProvider::class,
		\ForggeAppCore\Config\ConfigServiceProvider::class,
		\ForggeAppCore\Image\ImageServiceProvider::class,
		\ForggeAppCore\Sidebar\SidebarServiceProvider::class,
	 ...
	 * - 'forgge' - Internal group applied the same way 'global' is.
	 *
	 * Warning: The 'forgge' group contains some internal Forgge
